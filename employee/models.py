...
class Employee(models.Model):
    ...
    leave_balance = models.PositiveIntegerField(default=50)
...
class Leave_policy(models.Model):
    policy = models.FileField(_('leave policy'),upload_to='leave policies',blank=True,  null=True,help_text='upload pdf file less than 2.0MB')#work on path username-date/image
